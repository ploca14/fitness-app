...
function CreatePersonalTrainer() {
  ...
  const mutation = useMutation(newPersonalTrainer => {
  ...
  async function onSubmit(newPersonalTrainer) {
    await mutation.mutate(newPersonalTrainer)
  }
  ...
  return (
    <Page pageName={`Create a new personal trainer`}>
      <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
        <div className="bg-white px-4 py-5 shadow sm:rounded-lg sm:p-6">
          <div className="md:grid md:grid-cols-3 md:gap-6">
            <div className="md:col-span-1">
              <h3 className="text-lg font-medium leading-6 text-gray-900">Personal trainer information</h3>
              <p className="mt-1 text-sm text-gray-500">
                Add basic information about the new personal trainer.
              </p>
            </div>
